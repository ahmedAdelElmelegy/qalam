...
class CityStoryView extends StatefulWidget {
  ...
  @override
  State<CityStoryView> createState() => _CityStoryViewState();
}

class _CityStoryViewState extends State<CityStoryView> {
  ...
  Widget build(BuildContext context) {
    final List<String> arabicContent = widget.city.getDetails('ar');
    final List<String> userLangContent = widget.city.getDetails(
      widget.languageCode,
    );

    final List<String> arParagraphs = arabicContent.isNotEmpty
        ? arabicContent
        : [widget.city.getDescription('ar')];

    final List<String> userLangParagraphs = userLangContent.isNotEmpty
        ? userLangContent
        : [widget.city.getDescription(widget.languageCode)];
