...
import 'clothing_story_app_bar_background.dart';
import 'clothing_story_content_card.dart';
import 'clothing_story_video_section.dart';
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: ClothingStoryAppBarBackground(
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildBuilderDelegate((context, index) {
                ...
                return ClothingStoryContentCard(
                  arText: arText,
                  userText: userText,
                  index: index,
                  languageCode: widget.languageCode,
