...
class ClothingIsland extends StatelessWidget {
  final int index;
  final dynamic clothing;
  final int total;
  final double width;
  final double height;
  ...
  const ClothingIsland({
    ...
    required this.selectedClothingIndex,
    required this.lang,
            ...
            children: [
              Stack(
                ...
                children: [
                  ...
                  if (selectedClothingIndex == index)
                    Container(
                          width: 115.w,
                          height: 115.w,
                          decoration: BoxDecoration(
