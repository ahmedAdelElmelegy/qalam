...
class FlashcardLocalService {
  Future<List<QuestionModel>> getFlashcards({
    ...
    try {
      final String response = await rootBundle.loadString('assets/data/speaking_challenges.json');
      ...
      return targetList.map((item) {
        return QuestionModel.fromJson(item as Map<String, dynamic>, locale: locale);
      }).toList();
    } catch (e) {
