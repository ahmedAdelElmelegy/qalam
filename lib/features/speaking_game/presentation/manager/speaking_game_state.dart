...
class SpeakingGameLoaded extends SpeakingGameState {
  ...
  final int currentCardIndex; // Unused if we just pop from top, but good for progress
  ...
  @override
  List<Object?> get props => [cards, currentCardIndex, correctAnswers, totalCards, recognizedText, isListening];
}
...
class SpeakingGameIncorrect extends SpeakingGameState {
  ...
  const SpeakingGameIncorrect({required this.card, required this.recognizedText});
