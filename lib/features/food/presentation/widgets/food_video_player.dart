...
class FoodVideoPlayer extends StatefulWidget {
  ...
  @override
  State<FoodVideoPlayer> createState() => _FoodVideoPlayerState();
}

class _FoodVideoPlayerState extends State<FoodVideoPlayer> {
  // Common state
