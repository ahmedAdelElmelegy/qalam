...
class TraditionsIsland extends StatelessWidget {
  final int index;
  final dynamic tradition;
  final int total;
  final double width;
  final double height;
  ...
  const TraditionsIsland({
    ...
    required this.selectedTraditionIndex,
    required this.lang,
            ...
            children: [
              Stack(
                ...
                children: [
                  ...
                  if (selectedTraditionIndex == index)
                    Container(
                          width: 115.w,
                          height: 115.w,
                          decoration: BoxDecoration(
